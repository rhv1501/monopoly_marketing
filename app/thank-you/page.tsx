...
export const metadata: Metadata = {
  ...
  description:
    "Thank you for contacting Monopoly Marketing. Our team will reach out within 24 hours regarding your enquiry.",
      ...
      <div className="relative z-10 max-w-2xl w-full">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.06)] border border-zinc-100 overflow-hidden">
          ...
          <div className="p-8 sm:p-14 text-center">
            ...
            <p className="text-zinc-500 text-lg sm:text-xl max-w-md mx-auto leading-relaxed mb-10">
              ...
              . Our team is already processing your request.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10 text-left">
              <div className="p-6 rounded-3xl bg-zinc-50/50 border border-zinc-100 transition-all hover:border-blue-200 hover:bg-white hover:shadow-lg hover:shadow-zinc-200/40 group">
                ...
                <p className="text-sm text-zinc-500 leading-relaxed">
                  A playground consultant will call you within 24 hours.
                </p>
              </div>
              <div className="p-6 rounded-3xl bg-zinc-50/50 border border-zinc-100 transition-all hover:border-blue-200 hover:bg-white hover:shadow-lg hover:shadow-zinc-200/40 group">
                <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-xl mb-4 group-hover:scale-110 transition-transform">
                ...
                <p className="text-sm text-zinc-500 leading-relaxed">
                  We will prepare a detailed price estimate based on your
                  specific needs.
                </p>
              </div>
            </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-zinc-400 text-sm mb-4">
            ...
            <a
              href={`tel:${phone}`}
              className="text-zinc-900 font-black hover:text-blue-600 transition-colors"
            >
              {phone}
            </a>
          </p>
